...
global.apikey = { 'https://api.saint.xyz': 'free' };
global.apiUrl = 'https://saint-api.koyeb.app/';
...
module.exports = {
  ...
  BOT_INFO: process.env.BOT_INFO || 'saint; Saintfloew;972528277755;https://i.imgur.com/6oRG106.jpeg',
  AUDIO_DATA: process.env.AUDIO_DATA || 'saint; saintfloew;https://i.imgur.com/fj2WE83.jpeg',
  STICKER_DATA: process.env.STICKER_DATA || 'saint;saint',
